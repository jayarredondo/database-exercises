...
INSERT INTO quotes (author_first_name, author_last_name, quote)
VALUES ('John', 'Price', 'War used to be simple. Kill or be killed. Survive at all costs. Then everything changed. The action got faster, the weapons got more powerful, the stakes got bigger than anything we''d ever seen. On the eve of our greatest battle, a new hero must rise.')
